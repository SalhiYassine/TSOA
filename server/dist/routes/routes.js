...
function RegisterRoutes(app) {
    ...
    // ###########################################################################################################
    app.get('/v1/user/:userId', ...((0, runtime_1.fetchMiddlewares)(UserController_1.UsersController)), ...((0, runtime_1.fetchMiddlewares)(UserController_1.UsersController.prototype.getUser)), function UsersController_getUser(request, response, next) {
        const args = {
    ...
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.post('/v1/user', ...((0, runtime_1.fetchMiddlewares)(UserController_1.UsersController)), ...((0, runtime_1.fetchMiddlewares)(UserController_1.UsersController.prototype.createUser)), function UsersController_createUser(request, response, next) {
        const args = {
